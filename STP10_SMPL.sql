...
sample
when iso_ctry_cd_2 = 'CN' and sls_chnl_cd = 'OFFLINE' then 70 --FY17H2M12
when iso_ctry_cd_2 = 'CN' and sls_chnl_cd = 'ONLINE' then 30  --FY17H2M12
when iso_ctry_cd_2 = 'JP' and sls_chnl_cd = 'OFFLINE' and so_lcl_chnl_cd <> '35023'  then 60 --FY17H2M12
when iso_ctry_cd_2 = 'JP' and sls_chnl_cd = 'ONLINE' and so_lcl_chnl_cd <> '35023' then 101 --FY17H2M12
when iso_ctry_cd_2 = 'IN' and sls_chnl_cd = 'OFFLINE' then 40 --FY17H2M12
when iso_ctry_cd_2 = 'US' and sls_chnl_cd = 'OFFLINE' then 1833 --FY17H2M12
when iso_ctry_cd_2 = 'US' and sls_chnl_cd = 'ONLINE' then 1833 --FY17H2M12
when iso_ctry_cd_2 = 'BR' and sls_chnl_cd = 'OFFLINE' then 108 --FY17H2M12
when iso_ctry_cd_2 = 'BR' and sls_chnl_cd = 'ONLINE' then 250 --FY17H2M12
when iso_ctry_cd_2 = 'GB' and sls_chnl_cd = 'OFFLINE' then 144 --FY17H2M12
when iso_ctry_cd_2 = 'GB' and sls_chnl_cd = 'ONLINE' then 144 --FY17H2M12
when iso_ctry_cd_2 = 'AU' and sls_chnl_cd = 'OFFLINE' then 71 --FY18H1
when iso_ctry_cd_2 = 'AU' and sls_chnl_cd = 'ONLINE' then 71 --FY18H1 
when iso_ctry_cd_2 = 'FR' and sls_chnl_cd = 'OFFLINE' then 104 --FY17H1
when iso_ctry_cd_2 = 'FR' and sls_chnl_cd = 'ONLINE' then 104 --FY17H1
when iso_ctry_cd_2 = 'DE' and sls_chnl_cd = 'OFFLINE' then 94 --FY17H1
when iso_ctry_cd_2 = 'DE' and sls_chnl_cd = 'ONLINE' then 94 --FY17H1
when iso_ctry_cd_2 = 'SE' and sls_chnl_cd = 'ONLINE' then 80 --FY17H1
end;
